      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-lg border bg-card p-6">
          <div className="flex items-center justify-between">
            ...
            <Link to={`/workspace/integrations`} className="text-sm text-primary hover:underline">
              View all
            </Link>
          </div>
        ...
        <section className="rounded-lg border bg-card p-6">
          <div className="flex items-center justify-between">
            ...
            <Link to={`/workspace/projects`} className="text-sm text-primary hover:underline">
              View all
            </Link>
          </div>
          {(data?.recentProjects ?? []).length === 0 ? (
            <p className="mt-4 text-sm text-muted-foreground">
              No projects yet.{" "}
              <Link to={`/workspace/projects/new`} className="text-primary hover:underline">
