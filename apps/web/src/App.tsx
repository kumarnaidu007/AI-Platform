...
import { CompanyJiraPortalPage } from "@/pages/company/CompanyJiraPortalPage";

import { CompanyTicketWorkspacePage } from "@/pages/company/CompanyTicketWorkspacePage";
    ...
    <Routes>
      ...
      <Route path="/workspace" element={<CompanyProtectedRoute />}>
        ...
        <Route element={<CompanyLayout />}>
          ...
          <Route path="jira" element={<CompanyJiraPortalPage />} />

          <Route path="jira/:issueKey" element={<CompanyTicketWorkspacePage />} />
